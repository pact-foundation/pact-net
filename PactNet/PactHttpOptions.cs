...
namespace PactNet
{
    public class PactHttpOptions
    {
        ...
        public PactHttpOptions() { }

        public PactHttpOptions SetBasicAuthentication(string username, string password)
        {
        ...
        public PactHttpOptions SetBearerAuthentication(string token)
        {
        ...
        public PactHttpOptions SetSslCaFilePath(string pathToSslCaFile)
        {
        ...
        public PactHttpOptions SetHttpProxy(string httpProxy)
        {
        ...
        public PactHttpOptions SetHttpProxy(string httpProxy, string httpsProxy)
        {
