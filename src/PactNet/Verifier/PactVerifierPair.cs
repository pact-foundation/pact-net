...
namespace PactNet.Verifier
{
    ...
    /// </summary>
    internal class PactVerifierPair : IPactVerifierPair
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="PactVerifierPair"/> class.
        /// </summary>
        ...
        internal PactVerifierPair(IDictionary<string, string> verifierArgs, IVerifierProvider verifier, PactVerifierConfig config)
        {
