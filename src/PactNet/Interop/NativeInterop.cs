...
namespace PactNet.Interop
{
    ...
    internal static class NativeInterop
    {
        ...
        public static extern StringResult WithMultipartSingleFileUpload(InteractionHandle interaction, InteractionPart part, string contentType, string filePath,  string partName);
