...
namespace PactNet.Interop
{
    ...
    internal static class NativeInterop
    {
        ...
        public static extern bool WithMultipartSingleFileUpload(InteractionHandle interaction, InteractionPart part, string filePath, string contentType, string partDelimiter );
